...
export default function Home() {
  ...
  return (
    <div className="matrix-dots flex flex-col gap-4 min-h-screen p-12 font-mono">
        ...
        <div className="text-theme-blue">
          {!lastUpdatedVisible ? (
            ...
            <div className="flex flex-col items-end">
              ...
              <p
                className={`text-3xl ${lastUpdated.getTime() < currentTime.getTime() - 600000 ? "text-theme-red" : lastUpdated.getTime() < currentTime.getTime() - 300000 ? "text-theme-amber" : ""}`}
              >
